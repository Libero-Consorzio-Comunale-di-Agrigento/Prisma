...
--changeset esasdelli:GDM_TRIGGER_AG_MEPR_TC runOnChange:true stripComments:false
CREATE OR REPLACE  TRIGGER "AG_MEPR_TC"
   AFTER INSERT OR UPDATE OR DELETE ON SEG_MEMO_PROTOCOLLO
/******************************************************************************
 NOME:        DATI_TC
