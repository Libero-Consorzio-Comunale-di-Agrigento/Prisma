...
--changeset esasdelli:GDM_TRIGGER_AG_CLAS_TC runOnChange:true stripComments:false
CREATE OR REPLACE  TRIGGER "AG_CLAS_TC"
   AFTER INSERT OR UPDATE OR DELETE ON SEG_CLASSIFICAZIONI
/******************************************************************************
 NOME:        DATI_TC
