...
--changeset esasdelli:AGSPR_VIEW_SO4_V_INDIRIZZI_TELEMATICI runOnChange:true stripComments:false

  CREATE OR REPLACE FORCE VIEW "SO4_V_INDIRIZZI_TELEMATICI" ("OTTICA_UO", "UTENTE_AGGIORNAMENTO", "UTENTE", "TIPO_INDIRIZZO", "TIPO_ENTITA", "TAG_MAIL", "SSL", "SERVER", "PROTOCOL", "PORT", "PASSWORD", "NOTE", "INDIRIZZO", "PROGR_UO", "DAL_UO", "ID_INDIRIZZO", "PROGR_AOO", "DAL_AOO", "ID_AMMINISTRAZIONE", "DAL_AMM", "DATA_AGGIORNAMENTO", "AUTHENTICATION", "DES_TIPO_INDIRIZZO") AS 
