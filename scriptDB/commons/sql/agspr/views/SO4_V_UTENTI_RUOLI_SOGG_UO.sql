...
--changeset esasdelli:AGSPR_VIEW_SO4_V_UTENTI_RUOLI_SOGG_UO runOnChange:true stripComments:false

  CREATE OR REPLACE FORCE VIEW "SO4_V_UTENTI_RUOLI_SOGG_UO" ("ID_SOGGETTO", "UTENTE", "ID_COMPONENTE", "COMP_DAL", "COMP_AL", "RUOLO", "RUOLO_DAL", "RUOLO_AL", "UO_PROGR", "UO_DAL", "UO_AL", "OTTICA") AS 
