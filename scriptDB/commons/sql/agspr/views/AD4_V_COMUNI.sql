...
--changeset esasdelli:AGSPR_VIEW_AD4_V_COMUNI runOnChange:true stripComments:false

  CREATE OR REPLACE FORCE VIEW "AD4_V_COMUNI" ("ID", "COMUNE", "STATO", "PROVINCIA", "DENOMINAZIONE", "CAP", "SIGLA_CFIS", "DATA_SOPPRESSIONE") AS 
