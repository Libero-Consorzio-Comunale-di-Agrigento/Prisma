...
--changeset esasdelli:AGSPR_VIEW_SO4_V_DELEGHE runOnChange:true stripComments:false

  CREATE OR REPLACE FORCE VIEW "SO4_V_DELEGHE" ("ID_DELEGA", "DELEGANTE_SOGGETTO", "DELEGANTE_UTENTE", "DELEGATO_SOGGETTO", "DELEGATO_UTENTE", "OTTICA", "PROGR_UNITA_ORGANIZZATIVA", "RUOLO", "ID_APPLICATIVO", "ISTANZA_APPLICATIVO", "MODULO_APPLICATIVO", "ID_COMPETENZA_DELEGA", "CODICE_COMPETENZA_DELEGA", "DAL", "AL", "UTENTE_AGGIORNAMENTO", "DATA_AGGIORNAMENTO") AS 
  SELECT ID_DELEGA,
