...
--changeset esasdelli:AGSPR_VIEW_AS4_V_ANAGRAFICI_STRUTTURA runOnChange:true stripComments:false
  ...
  SELECT "NI",
          ...
          "NOTE",
          "UTENTE"
     FROM ${global.db.as4.username}.AS4_V_ANAGRAFICI_STRUTTURA
