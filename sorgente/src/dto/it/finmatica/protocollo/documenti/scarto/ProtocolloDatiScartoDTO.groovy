...
class ProtocolloDatiScartoDTO implements DTO<ProtocolloDatiScarto> {
    ...
    @Override
    ProtocolloDatiScarto getDomainObject() {
        return ProtocolloDatiScarto.get(id)
    }

    ProtocolloDatiScarto copyToDomainObject() {
        return null
    }
}