...
public class IntestazioneDocPrincipale {


    @XmlElement(name = "Identificatore", required = true)
    protected IdentificatoreDocPrincipale identificatore;
     ...
     *     
     */
    public IdentificatoreDocPrincipale getIdentificatore() {
     ...
     *     
     */
    public void setIdentificatore(IdentificatoreDocPrincipale value) {
