 ...
 *       &lt;sequence>
 *         &lt;element ref="{}RAPPORTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RAPPORTI")
public class Rapporti {

    @XmlElement(name = "RAPPORTO")
    protected List<Rapporto> rapporto;
     ...
     * This is why there is not a <CODE>set</CODE> method for the rapporto property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRAPPORTO().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Rapporto> getRAPPORTO() {
        if (rapporto == null) {
            rapporto = new ArrayList<Rapporto>();
        }
