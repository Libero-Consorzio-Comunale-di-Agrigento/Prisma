...
class TipoEsitoAccessoListaViewModel extends AfcAbstractGrid{
	...
	// dati
	List<TipoEsitoAccessoDTO> lista
	...
	private void caricaLista(String filterCondition = filtro) {
		PagedResultList listaP = TipoEsitoAccesso.createCriteria().list(max: pageSize, offset: pageSize * activePage) {
	...
	@Command void onModifica (@BindingParam("isNuovoRecord") boolean isNuovoRecord) {
		...
		Window w = Executions.createComponents ("/dizionari/tipoEsitoAccessoDettaglio.zul", self, [id: id])
		w.onClose {
			activePage 	= 0
			caricaLista()
			...
			new org.zkoss.zk.ui.event.EventListener() {
				void onEvent(Event e){
					if(Messagebox.ON_OK.equals(e.getName())) {
						...
						if(lista.size() == 1){
							TipoEsitoAccessoListaViewModel.this.activePage= TipoEsitoAccessoListaViewModel.this.activePage==0?0:TipoEsitoAccessoListaViewModel.this.activePage-1
						}
						accessoCivicoService.elimina(TipoEsitoAccessoListaViewModel.this.selectedRecord)
						TipoEsitoAccessoListaViewModel.this.selectedRecord = null
						TipoEsitoAccessoListaViewModel.this.caricaLista()
						BindUtils.postNotifyChange(null, null, TipoEsitoAccessoListaViewModel.this, "activePage")
						BindUtils.postNotifyChange(null, null, TipoEsitoAccessoListaViewModel.this, "lista")
						BindUtils.postNotifyChange(null, null, TipoEsitoAccessoListaViewModel.this, "totalSize")
						BindUtils.postNotifyChange(null, null, TipoEsitoAccessoListaViewModel.this, "selectedRecord")
