...
class TipoAccessoCivicoListaViewModel extends AfcAbstractGrid{
	...
	// dati
	List<TipoAccessoCivicoDTO> 	lista
	...
	private void caricaLista(String filterCondition = filtro) {
		PagedResultList listaP = TipoAccessoCivico.createCriteria().list(max: pageSize, offset: pageSize * activePage) {
	...
	@Command void onModifica (@BindingParam("isNuovoRecord") boolean isNuovoRecord) {
		...
		Window w = Executions.createComponents ("/dizionari/tipoAccessoCivicoDettaglio.zul", self, [id: id])
		w.onClose {
			activePage 	= 0
			caricaLista()
			...
			new org.zkoss.zk.ui.event.EventListener() {
				void onEvent(Event e){
					if(Messagebox.ON_OK.equals(e.getName())) {
						...
						if(lista.size() == 1){
							TipoAccessoCivicoListaViewModel.this.activePage= TipoAccessoCivicoListaViewModel.this.activePage==0?0:TipoAccessoCivicoListaViewModel.this.activePage-1
						}
						accessoCivicoService.elimina(TipoAccessoCivicoListaViewModel.this.selectedRecord)
						TipoAccessoCivicoListaViewModel.this.selectedRecord = null
						TipoAccessoCivicoListaViewModel.this.caricaLista()
						BindUtils.postNotifyChange(null, null, TipoAccessoCivicoListaViewModel.this, "activePage")
						BindUtils.postNotifyChange(null, null, TipoAccessoCivicoListaViewModel.this, "lista")
						BindUtils.postNotifyChange(null, null, TipoAccessoCivicoListaViewModel.this, "totalSize")
						BindUtils.postNotifyChange(null, null, TipoAccessoCivicoListaViewModel.this, "selectedRecord")
